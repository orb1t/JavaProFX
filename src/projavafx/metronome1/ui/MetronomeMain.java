...
public class MetronomeMain extends Application {
	...
	Timeline anim = TimelineBuilder.create()
			.autoReverse(true)
			.keyFrames(
					new KeyFrame(new Duration(5000.0), new KeyValue(startXVal, 100.0)),
					new KeyFrame(new Duration(10000.0), new KeyValue(startXVal, 300.0, Interpolator.LINEAR)
					)
			)
