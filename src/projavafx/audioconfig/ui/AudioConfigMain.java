...
import projavafx.audioconfig.moel.AudioConfigModel;
...
public class AudioConfigMain extends Application {
	...
	public void start(Stage stage) throws Exception {
				...
				.root(
						GroupBuilder.create()
							.children(
									...
									.fill(
											LinearGradientBuilder.create().endX(0.0).endY(1.0)
												.stops(
														new Stop(0.0, Color.web("0xAEBBCC")),
														new Stop(1.0, Color.web("0x6D84A3"))
												)
												.build()
									)
									.build(),
									TextBuilder.create().layoutX(65).layoutY(12).textOrigin(VPos.TOP)
									.fill(Color.WHITE)
									.text("Audio Configuration")
									.font(Font.font("SansSerif", FontWeight.BOLD, 20))
									.build(),
									RectangleBuilder.create().x(0).y(43).width(320).height(300)
									...
									.build(),
									textDb = TextBuilder.create().layoutX(18)
									.layoutY(69)
									.textOrigin(VPos.TOP)
									...
									.stroke(Color.color(0.66, 0.67, 0.69))
									.build(),
									TextBuilder.create().layoutX(18).layoutY(113)
									.textOrigin(VPos.TOP)
									.fill(Color.web("#131021"))
									.text("Muting")
		...
		stage.setTitle("Audio Configureation");
		stage.show();
