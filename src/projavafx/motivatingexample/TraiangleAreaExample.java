...
public class TraiangleAreaExample {
	...
	public static void main(String[] args) {
		...
		printResult(x1, y1, x2, y3, x3, y3, area);
	...
	private static void printResult(IntegerProperty x1, IntegerProperty y1, IntegerProperty x2, IntegerProperty y2, IntegerProperty x3, IntegerProperty y3, NumberBinding area){
